...
var o=function(){};o.prototype.getChildContext=function(){return{store:this.props.store}}, o.prototype.render=function(t){return t.children[0]};var e=function(){
var arguments$1 = arguments;
...
var t=function(n){return"A"===n.tagName?n:n.parentElement?t(n.parentElement):null}; var e$1=function(n){return n&&n.origin===window.location.origin?n.href.replace(window.location.origin,""):null};function r(r){var a=r.onInternalNav,i=r.children,l=r.className;return h("div",{className:l,onClick:function(n){var r=t(n.target);if(r&&"_blank"!==r.target){var i=e$1(r),l=n.ctrlKey||n.shiftKey||n.altKey||n.metaKey||0!==n.button;i&&!l&&(n.preventDefault(), a(i));}}},i)}
//# sourceMappingURL=index.m.js.map
...
var Layout = function (ref) {
  var doUpdateUrl = ref.doUpdateUrl;
  var currentComponent = ref.currentComponent;
  ...
  var Page = componentMap[currentComponent];
  return (
    h( r, { onInternalNav: doUpdateUrl },
      h( 'main', { class: 'ph3 ph4-ns pt3 bt b--black-10 black-60' },
        h( 'nav', { class: 'pa3 pa4-ns' },
          h( 'p', { class: 'b f3 tc f2-ns black-70 lh-solid mb0' }, "redux-bundler sample app"),
          h( 'p', { class: 'f6 db b tc pb2' }, "By: ", h( 'a', { href: 'https://twitter.com/henrikjoreteg', class: 'link blue dim' }, "@HenrikJoreteg")),
          h( 'div', { class: 'tc pb3' },
            navItems.map(function (item) {
              return (
                h( 'a', { class: ("link dim gray f6 f5-ns dib pa2 mr1 " + (item.url === pathname ? 'bg-lightest-blue' : '')), href: item.url }, item.label)
              )
            })
          )
        ),
...
function rootComp (store) { return (
  h( o, { store: store },
    h( Layout$1, null )
  )
); }
...
var init = function () {
  var worker = window.worker = new Worker('/b/w.js');
  var post = function (val) { return worker.postMessage(val); };
  ...
  var getStoreProxy = function (worker) {
    var combinedData = {};
    ...
    var select = function (selectorNames) { return selectorNames.reduce(function (obj, name) {
        var valueName = selectorNameToValueName(name);
        obj[valueName] = combinedData[valueName];
        return obj
      }, {}); };

    return {
      getAll: function () { return combinedData; },

      select: select,

      subscribeToSelectors: function (keys, callback) {
        var subscription = {
          fn: callback,
      ...
      action: function (name, args) {
        post({type: 'action', name: name, payload: args});
      }
    }
  };

  var proxy = getStoreProxy(worker);
